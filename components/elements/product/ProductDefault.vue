    ...
    <div class="ps-product">
        ...
        <div class="ps-product__container">
            ...
            <div class="ps-product__content">
                ...
                v-if="!product.variants"
                class="ps-product__price sale">
                  {{ currency }} {{ product.selling_price }} <del class="ml-2" v-if="product.price">  {{ currency }} {{ product.price }} </del>
                </p>
                <p
                v-else
                class="ps-product__price sale">
                    From  {{ currency }} {{ product.variants[0].selling_price }}  <del class="ml-2" v-if="product.variants[0].price"> {{ currency }} {{ product.variants[0].price }}  </del>
                </p>
            </div>
            <div class="ps-product__content hover">
                ...
                v-else
                class="ps-product__price sale">
                    {{ currency }} {{ product.selling_price }} <del class="ml-2" v-if="product.pricen !=''">  {{ currency }} {{ product.price }} </del>
                </p>
